...
export default function Sidebar({
  ...
  return (
    <div className={`bg-sidebar border-primary flex h-full flex-col border-r transition-all duration-300 ${
      ...
      <div className="border-primary flex items-center justify-between border-b p-4">
        {!isCollapsed ? (
          ...
          <button
            onClick={onToggleCollapse}
            className="text-secondary hover:text-primary mx-auto p-1 rounded transition-colors"
      ...
      <div className={`border-primary flex border-b ${isCollapsed ? "flex-col" : ""}`}>
        ...
        >
          <FaRobot className={isCollapsed ? "mx-auto" : "mr-1 inline"} />
          {!isCollapsed && "Models"}
        </button>
        <button
        ...
        >
          <FaFileAlt className={isCollapsed ? "mx-auto" : "mr-1 inline"} />
          {!isCollapsed && "Files"}
        </button>
        <button
        ...
        >
          <FaPlug className={isCollapsed ? "mx-auto" : "mr-1 inline"} />
          {!isCollapsed && "Plugins"}
        </button>
        <button
